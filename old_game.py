...
def main():
    ...
    #roles = ['Судья', 'Маньяк', 'Адвокааааааат', 'Друг маньяка, который его покрывает',
    ...
    #         'Иван Эрлих (умоляет, чтобы отчислили Перша)', 'Никита Першуков (пришёл поныть)', 'Салыч']
    ...
    #location = 'Бассейн'
    #roles = ['Инструктор по плаванию', 'Утопленик', 'Беременная женщина', 'Пловец',
    #         'Ребенок, который учится плавать']

    #location = 'Фабрика Санта Клауса'
    #roles = ['Санта', 'Русский Дед Мороз (пришёл устранять конкурента)', 'Фея леденцов', 'Гномик, заворачивающий подарки (или не гном, я хуй знает кто там у них, пусть блять гномик будет, гомик нахуй)',
    #         'Мальчик Саша, который пришёл на экскурсию']

    # location = 'Тюрячка!'
    # roles = ['Вор в законе', 'Петух', 'Кольщик', 'Смотрящий', 'Старик, отбывающий пожизненное']

    # location = 'Кладбище'
    # roles = ['Труп', 'Алчный продавец памятников', 'Скорбящий родственник', 'Смерть', 'Кладоискатель']
